...
# python calibration.py -d C:\Users\user\Desktop\checker5  -s 9 -t 6 -w 9
# units = mm
...
if __name__ == '__main__':
    ...
    ap.add_argument("-w", "--width", type=int, help="Width of checkerboard")
    ap.add_argument("-t", "--height", type=int, help="Height of checkerboard")
    ap.add_argument("-s", "--square_size", type=float, default=1, help="Length of one edge (meters)")
