...
#python WORKS.py --type DICT_5X5_100 --camera True --K_Matrix calibration_matrix.npy --D_Coeff distortion_coefficients.npy
...
ax.clear()
line, = ax.plot(time_list,z_list, 'r-')
...
while True:
    ...
    z_list.append(newZ)
    time_list.append(xf)
    line.set_data(time_list,z_list)
    ax.set_ylim((-10,max(350,max(z_list))))
    ax.set_xlim((0,(xf+10)))
